import pygame, sys, menu, random, credits
...
def run_game(ScreenStatus, CharacterChoosen, LanguageSelected, SubLevel):
    ...
    # Cargar imágenes
    Mapa_Nivel = pygame.image.load("imagenes/Nivel3Map.png")
    ...
    Letra_L = pygame.transform.scale(pygame.image.load("Letras/Blancas/Ijuego.png"), (LetrasEscala_X, LetrasEscala_Y))
    ...
    Letra_K = pygame.transform.scale(pygame.image.load("Letras/Blancas/Kjuego.png"), (LetrasEscala_X, LetrasEscala_Y))
    Letra_N = pygame.transform.scale(pygame.image.load("Letras/Blancas/Njuego.png"), (LetrasEscala_X, LetrasEscala_Y))
    Letra_B = pygame.transform.scale(pygame.image.load("Letras/Blancas/Bjuego.png"), (LetrasEscala_X, LetrasEscala_Y))
    ...
    RandomEnglishQuoteLose = random.choice(['NOT GIVE UP!', 'TRY IT UNTIL YOU DONE!'])
    ...
    if Language == "English" and SubLevel == "SubLevel1" or SubLevel == "SubLevel2" and Language == "Spanish":
        Time = 40
    else:
        Time = 30
    pause_start_time = 0
    ...
    while running:
        ...
        if StatusScreen == "Game":
            ...
            for target in targets[:]:  # [:] para hacer una copia de la lista mientras iteramos
                if check_collision(player_pos, player_size, target[:2], Letra_A_Size):
                    ...
                    if SubLevel == "SubLevel1":
                        if Language == "Spanish":
                            if randomLetters == 1 and PInt < 1:
                                PInt += 1
                            elif randomLetters == 2 and OInt < 2:
                                OInt += 1
                            elif randomLetters == 3 and LInt < 2:
                                LInt += 1
                            else:
                                Life -= 1
                        if Language == "English":
                            if randomLetters == 1 and CInt < 2:
                                CInt += 1
                            elif randomLetters == 2 and HInt < 1:
                                HInt += 1
                            elif randomLetters == 3 and IInt < 1:
                                IInt += 1
                            elif randomLetters == 4 and KInt < 1:
                                KInt += 1
                            elif randomLetters == 5 and EInt < 1:
                                EInt += 1
                            elif randomLetters == 6 and NInt < 1:
                                NInt += 1
                            else:
                                Life -= 1
                    ...
                    if SubLevel == "SubLevel2":
                        if Language == "Spanish":
                            if randomLetters == 1 and CInt < 1:
                                CInt += 1
                            elif randomLetters == 2 and AInt < 2:
                                AInt += 1
                            elif randomLetters == 3 and BInt < 1:
                                BInt += 1
                            elif randomLetters == 4 and LInt < 2:
                                LInt += 1
                                ...
                                Life -= 1
                        if Language == "English":
                            if randomLetters == 1 and HInt < 1:
                                HInt += 1
                            elif randomLetters == 2 and OInt < 1:
                                OInt += 1
                            elif randomLetters == 3 and RInt < 1:
                                RInt += 1
                            elif randomLetters == 4 and SInt < 1:
                                SInt += 1
                            elif randomLetters == 5 and EInt < 1:
                                EInt += 1
                            else:
            ...
            if PauseValue == False and not Status == "Winner" and not Status == "Lose":
                ...
                if current_time - Last_Letter_Time > 2000:  # Cada 2 segundos
                    ...
                    if SubLevel == "SubLevel1":
                        ...
                        if Language == "English":
                            randomLetters = random.choice([1, 2, 3, 4, 5, 6])
                    if SubLevel == "SubLevel2":
            ...
            for Letra_target in targets:
                if SubLevel == "SubLevel1":
                    if Language == "Spanish":
                        ...
                        if randomLetters == 3:
                            screen.blit(Letra_L, Letra_target[:2])
                        if randomLetters == 4:
                    ...
                    if Language == "English":
                        ...
                        if randomLetters == 4:
                            screen.blit(Letra_K, Letra_target[:2])
                        if randomLetters == 5:
                            screen.blit(Letra_E, Letra_target[:2])
                        if randomLetters == 6:
                            screen.blit(Letra_N, Letra_target[:2])
                if SubLevel == "SubLevel2":
                    if Language == "Spanish":
                        if randomLetters == 1:
                            screen.blit(Letra_C, Letra_target[:2])
                        ...
                        if randomLetters == 3:
                            screen.blit(Letra_B, Letra_target[:2])
                        if randomLetters == 4:
                            screen.blit(Letra_L, Letra_target[:2])
                        if randomLetters == 5:
                            screen.blit(Letra_O, Letra_target[:2])
            ...
            if SubLevel == "SubLevel1":
                if Language == "Spanish":
                    if PInt >= 1:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Amarillas/Pama.png"), (LetrasEscala_X, LetrasEscala_Y)),  (430, 20))
                    else:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Grises/P.png"), (LetrasEscala_X, LetrasEscala_Y)),  (430, 20))
                    if LInt >= 1:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Amarillas/Lama.png"), (LetrasEscala_X, LetrasEscala_Y)),  (494  , 20))
                    else:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Grises/L.png"), (LetrasEscala_X, LetrasEscala_Y)), (494 , 20))
                    if OInt >= 1:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Amarillas/Oama.png"), (LetrasEscala_X, LetrasEscala_Y)), (462 , 20))
                    else:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Grises/O.png"), (LetrasEscala_X, LetrasEscala_Y)), (462, 20))
                    if LInt >= 2:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Amarillas/Lama.png"), (LetrasEscala_X, LetrasEscala_Y)), (526 , 20))
                    else:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Grises/L.png"), (LetrasEscala_X, LetrasEscala_Y)), (526 , 20))
                    if OInt >= 2:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Amarillas/Oama.png"), (LetrasEscala_X, LetrasEscala_Y)), (560, 20 ))
                    else:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Grises/O.png"), (LetrasEscala_X, LetrasEscala_Y)), (560, 20))
                if Language == "English":
                    if CInt >= 1:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Amarillas/Cama.png"), (LetrasEscala_X, LetrasEscala_Y)),  (420 , 10))
                    else:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Grises/C.png"), (LetrasEscala_X, LetrasEscala_Y)),  (420 , 10))
                    if CInt >= 2:
                    ...
                    if IInt >= 1:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Amarillas/Iama.png"), (LetrasEscala_X, LetrasEscala_Y)),  (484   , 10))
                    else:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Grises/I.png"), (LetrasEscala_X, LetrasEscala_Y)),  (484  , 10))
                    if HInt >= 1:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Amarillas/Hama.png"), (LetrasEscala_X, LetrasEscala_Y)),  (452 , 10))
                    else:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Grises/H.png"), (LetrasEscala_X, LetrasEscala_Y)),  (452 , 10))
                    if KInt >= 1:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Amarillas/Kama.png"), (LetrasEscala_X, LetrasEscala_Y)),  (548 , 10))
                    else:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Grises/K.png"), (LetrasEscala_X, LetrasEscala_Y)),  (548 , 10))
                    if NInt >= 1:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Amarillas/Nama.png"), (LetrasEscala_X, LetrasEscala_Y)),  (612, 10))
                    else:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Grises/N.png"), (LetrasEscala_X, LetrasEscala_Y)),  (612, 10))
                    if EInt >= 1:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Amarillas/Eama.png"), (LetrasEscala_X, LetrasEscala_Y)),  (580, 10))
                    else:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Grises/E.png"), (LetrasEscala_X, LetrasEscala_Y)),  (580, 10))
            ...
            if SubLevel == "SubLevel2":
                if Language == "Spanish":
                    if CInt >= 1:
                        ...
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Grises/C.png"), (LetrasEscala_X, LetrasEscala_Y)),  (420 , 10))
                    if AInt >= 1:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Amarillas/Aama.png"), (LetrasEscala_X, LetrasEscala_Y)),  (452  , 10))
                    else:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Grises/A.png"), (LetrasEscala_X, LetrasEscala_Y)),  (452 , 10))
                    if BInt >= 1:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Amarillas/Bama.png"), (LetrasEscala_X, LetrasEscala_Y)),  (484   , 10))
                    else:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Grises/B.png"), (LetrasEscala_X, LetrasEscala_Y)),  (484  , 10))
                    if AInt >= 2:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Amarillas/Aama.png"), (LetrasEscala_X, LetrasEscala_Y)),  (516 , 10))
                    else:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Grises/A.png"), (LetrasEscala_X, LetrasEscala_Y)),  (516 , 10))
                    if LInt >= 1:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Amarillas/Lama.png"), (LetrasEscala_X, LetrasEscala_Y)),  (548 , 10))
                    else:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Grises/L.png"), (LetrasEscala_X, LetrasEscala_Y)),  (548 , 10))
                    if LInt >= 2:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Amarillas/Lama.png"), (LetrasEscala_X, LetrasEscala_Y)),  (580, 10))
                    else:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Grises/L.png"), (LetrasEscala_X, LetrasEscala_Y)),  (580, 10))
                    if OInt >= 1:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Amarillas/Oama.png"), (LetrasEscala_X, LetrasEscala_Y)),  (612, 10))
                    else:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Grises/O.png"), (LetrasEscala_X, LetrasEscala_Y)),  (612, 10))
                if Language == "English":
                    if HInt >= 1:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Amarillas/Hama.png"), (LetrasEscala_X, LetrasEscala_Y)),  (440, 30))
                    else:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Grises/H.png"), (LetrasEscala_X, LetrasEscala_Y)),  (440, 30))
                    if OInt >= 1:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Amarillas/Oama.png"), (LetrasEscala_X, LetrasEscala_Y)),  (470, 30))
                    else:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Grises/O.png"), (LetrasEscala_X, LetrasEscala_Y)), (470, 30))
                    if RInt >= 1:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Amarillas/Rama.png"), (LetrasEscala_X, LetrasEscala_Y)), (500, 30))
                    else:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Grises/R.png"), (LetrasEscala_X, LetrasEscala_Y)), (500, 30))
                    if SInt >= 1:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Amarillas/Sama.png"), (LetrasEscala_X, LetrasEscala_Y)), (530, 30))
                    else:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Grises/S.png"), (LetrasEscala_X, LetrasEscala_Y)), (530, 30))
                    if EInt >= 1:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Amarillas/Eama.png"), (LetrasEscala_X, LetrasEscala_Y)), (560, 30))
                    else:
                        screen.blit(pygame.transform.scale(pygame.image.load("Letras/Grises/E.png"), (LetrasEscala_X, LetrasEscala_Y)), (560, 30))
            ...
            if SubLevel == "SubLevel2":
                if Language == "Spanish":
                    if CInt >= 1 and AInt >= 2 and BInt >= 1 and LInt >= 2 and OInt >= 1:
                        Status = "Winner"
                if Language == "English":
                    if HInt >= 1 and OInt >= 1 and RInt >= 1 and SInt >= 1 and EInt >= 1:
                        Status = "Winner"
            ...
            if Status == "Winner" or Status == "Lose" or PauseValue == True:
                    ...
                    if SubLevel == "SubLevel2":
                        if Status == "Winner":
                            RepeatLevel = pygame.Rect(90, 140, 210, 80)
                            BackMenu = pygame.Rect(370, 100, 210, 80)
                            CreditsGo = pygame.Rect(640, 140, 210, 20)
                            if Language == "English":
                                screen.blit(pygame.image.load("imagenes/INGLESmenuwin.png"), (0 ,0))
                                draw_text(RandomEnglishQuoteWin, font_8bit, (255, 255, 255), screen, 490  , 460 )
                            else:
                                screen.blit(pygame.image.load("imagenes/winmenu.png"), (0 ,0))
                                draw_text(RandomSpanishQuoteWin, font_8bit, (255, 255, 255), screen, 490  , 460)
                    if Status == "Lose":
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    if Status == "Winner" or Status == "Lose" or PauseValue == True:
                        ...
                        if Status == "Winner":
                            ...
                            if SubLevel == "SubLevel2":
                                if CreditsGo.collidepoint(event.pos):
                                    credits.creditsWall(LanguageSelected=Language)
                        if BackMenu.collidepoint(event.pos):
                            menu.Menu_Run(LanguageSelected=Language)
                    if pygame.Rect(30, 30, 70, 70).collidepoint(event.pos):
                        PauseValue = True
